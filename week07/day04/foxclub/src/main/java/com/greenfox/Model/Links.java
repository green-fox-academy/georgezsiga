...
public enum Links {
  ...
  NUTRITIONSTORE("Nutrition Store", "/nutritionStore", " You are what you eat. Give me Fooood!! "),
  TRICKCENTER("Trick Center", "/trickCenter", " Knowledge is power! Let`s learn something! "),
  ACTIONHISTORY("Action History", "/actionHistory", " Check out what your Poke did recently "),
