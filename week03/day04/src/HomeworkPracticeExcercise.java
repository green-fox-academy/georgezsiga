 ...
 */
public class HomeworkPracticeExcercise {
  public static void mainDraw(Graphics graphics) {

    dumbRecursion(1);          // calls the function
    count(10);
  }

  public static void dumbRecursion2(int i) {     // recursion
    System.out.println(i++);      // do this
    dumbRecursion2(i);                       // calls itself ... infinite...
  }

  public static void dumbRecursion(int i) {     // recursion
    System.out.println("its working" + i++);      // do this
    if (i < 10)                              // until it reaches this many loops
      dumbRecursion(i);                       // calls itself ... infinite...
    return;
  }
...
//
//            first... write "if"
//            there must be 2 cases..where the method calls itself and a base case where the method does not
//            second.... handle the simple case  base
//            third ... write the recursive call
//            4th... assume the recursive call works...
